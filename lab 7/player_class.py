...
class Songs():
    ...
    def load_song(self):
        ...
        pygame.mixer.music.load(f"lab 7/{self.name}")
        self.song_length = pygame.mixer.Sound(f"lab 7/{self.name}").get_length()
...
class Button():
    def __init__(self, screen: pygame.Surface, size: tuple, pos: tuple, text: str, font_size: int, font_color: tuple, key: pygame.key, alternative_text = None, turn_on = None) -> None:
